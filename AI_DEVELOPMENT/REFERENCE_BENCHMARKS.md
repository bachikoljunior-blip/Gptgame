...
Repository evidence baseline: state checkpoint main `547ba6662b82939f4dca9f5d4d9b409163519250`, current public operational revision `0efbceaa583b4ce51c432445d906c8b76f68b0b4`, product build `2026.08.01-f`.
...
| Performance/stability | 46 candidate tests including artifact tamper rejection, explicit caps, adaptive DPR/quality, exact reload restoration, and a currently verified build-f public surface | No physical iPhone/Android seven-loop diagnostic run; content-addressed artifact identity and automatic restoration still require the scheduled remote failure/normal-delivery proof. |
